...
// node_modules/@react-map/india/dist/index.mjs
...
var useMousePosition = () => {
  const [position, setPosition] = (0, import_react2.useState)({ x: 0, y: 0 });
...
var IndiaSingle = ({
  ...
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("div", { className: "map", style: mapStyle }, import_react.default.createElement("svg", { version: "1.1", id: `svg2-${instanceId}`, x: "0px", y: "0px", viewBox }, stateCode == null ? void 0 : stateCode.map((code, index) => import_react.default.createElement(
    "path",
    {
      key: index,
  ...
  )))), hints && stateHovered && import_react.default.createElement("div", { style: hintStyle }, stateHovered));
};
var IndiaMultiple = ({
  size,
  mapColor,
